...
function newton_krylov_with_logs(
    ...
    while normr > tol && k < max_outer
        ...
        # 👉 call extracted GMRES
        Δθ, gmres_current, jmax = gmres_logged(
            v -> Jv(θ_vec, r, v),
            -r;
            m=m,
            tol=tol,
...
export preconditioned_newton_krylov

function preconditioned_newton_krylov(
    θ::Array{Float64,4},
    residual_fun::Function,
...
export preconditioned_newton_krylov_with_logs

function preconditioned_newton_krylov_with_logs(
    θ::Array{Float64,4},
    residual_fun::Function,
    elt::FixedPointElements,shift;
    tol=1e-8,
