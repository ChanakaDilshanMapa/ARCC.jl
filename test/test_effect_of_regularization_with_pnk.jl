...
θ_final_pnk, θ_benchmark_pnk, newton_pre_pnk, newton_post_pnk, gmres_residuals_pnk, num_evals_pnk = preconditioned_nk_solver_factory_with_logs(new_S, zeros_mo, nocc, n_b, Cscf, f, peris, t_mp2, max_outer_nk, tol, 5, 25)(T_I);
################################################################
