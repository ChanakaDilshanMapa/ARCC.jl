...
plot!(p_fp, [NaN], [NaN], label="FP MO basis", color=:darkgreen, linestyle=:solid, linewidth=2)
plot!(p_fp, [NaN], [NaN], label="FP AO basis", color=:magenta, linestyle=:solid, linewidth=2)
plot!(p_fp, [NaN], [NaN], label="FP Shifted AO basis", color=:orange, linestyle=:solid, linewidth=2)
